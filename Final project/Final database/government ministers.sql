CREATE TABLE IF NOT EXISTS government_ministers (
...
INSERT INTO government_ministers VALUES
    ...
    ('p17','<Hossein_Fatemi>','سیدحسین فاطمی@fas'),
    ('p5','<Mohammadreza_Nematzadeh>','محمدرضا نعمت‌زاده@fas'),
    ('p4','<Ali_Larijani>','علي املي لاريجاني@fas'),
    ('p12','<Gholam_Hossein_Sadighi>','غلامحسين صديقي@fas'),
    ('p10','<Hosein_Dadgar>','Dadgar'),
    ('p9','<Firouz_Nosrat-ed-Dowleh_III>','Firouz Nosrat-ed-Dowleh III@eng'),
    ('p2','<Abbas_Adham>','Abbas Adham@eng'),
    ...
    ('p111','<de/Ebrahim_Alam>','Ebrahim Alam@de'),
    ('p110','<Ali_Kordan>','علي كردان@fas'),
    ...
    ('p101','<Parviz_Varjavand>','پرویز ورجاوند@fas'),
    ('p86','<Mohammad_Ardakani>','Ardakani'),
    ('p84','<Isa_Kalantari>','Kalantari'),
    ('p83','<Abbas_Aram>','Abbas Aram'),
    ('p94','<Ali-Akbar_Zargham>','AliAkbar Zargham@eng'),
    ...
    ('p172','<Saeed_Emami>','سعيدامامي@fas'),
    ('p170','<Mahmoud_Hessaby>','دکتر محمود حسابی@fas'),
    ...
    ('p156','<Gholamreza_Nikpey>','غلامرضا نيك پي@fas'),
    ...
    ('p149','<Hassan_Pakravan>','حسن پاکروان@fas'),
    ('p147','<Ali_Fallahian>','فلاحیان@fas'),
    ('p148','<Behzad_Nabavi>','بهزاد نبوي@fas'),
    ('p136','<Mohammad_Gharazi>','مهندس غرضي@fas'),
    ('p135','<Mohsen_Nourbakhsh>','سيد محسن نوربخش@fas'),
    ('p130','<Rahman_Dadman>','رحمان دادمان@fas'),
    ...
    ('p137','<Hassan_Taqizadeh>','تقی‌زاده@fas'),
    ...
    ('p117','<Iraj_Eskandari>','ايرج اسكندري@fas'),
    ...
    ('p237','<de/Mohammed_Hossein_Saif_Qazi>','Seyfi Qazi@kur'),
    ...
    ('p245','<Teymur_Bakhtiar>','سپهبد تيمور بختيار@fas'),
    ...
    ('p241','<Amanullah_Jahanbani>','امان الله جهانباني@fas'),
    ('p231','<Hossein_Namazi>','Hossein Namazi@eng'),
    ('p230','<Mohammad_Javad_Tondguyan>','Mohammad'),
    ('p228','<Jafar_Towfighi>','جعفر توفيقي داريان@fas'),
    ('p233','<Dariush_Homayoon>','داريوش همايون@fas'),
    ...
    ('p209','<Amir_Abdollah_Tahmasebi>','عبدالله‌خان امیر طهماسبی@fas'),
    ('p208','<Mohsen_Rais>','Mohsen Rais@eng'),
    ...
    ('p193','<Ali_Akbar_Siassi>','Ali-Akbar Siassi@eng'),
    ...
    ('p186','<Hossein_Ghods-Nakhai>','Hossein Ghods-Nakhai@eng'),
    ('p184','<Mirza_Hassan_Khan_Esfandiary>','Mirza Hassan Khan Esfandiary@eng'),
    ...
    ('p178','<Ismail_Mumtaz>','اسماعيل ممتاز@fas'),
